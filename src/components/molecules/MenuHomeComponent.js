  ...
  return (
    <>
      <div className="menu-header d-flex justify-content-between p-4">
        ...
        <div
          className={`food-category-list${
            active === "Batang" ? " selected-category" : ""
          }`}
          onClick={() => handleCategory("Batang")}
        >
          Batang
        </div>
        <div
          className={`food-category-list${
            active === "Polong" ? " selected-category" : ""
          }`}
          onClick={() => handleCategory("Polong")}
        >
          Polong
        </div>
        <div
          className={`food-category-list${
            active === "Buah" ? " selected-category" : ""
          }`}
          onClick={() => handleCategory("Buah")}
        >
          Buah
        </div>
        <div
          className={`food-category-list${
            active === "Daun" ? " selected-category" : ""
          }`}
          onClick={() => handleCategory("Daun")}
        >
          Daun
        </div>
        <div
          className={`food-category-list${
            active === "Umbi" ? " selected-category" : ""
          }`}
          onClick={() => handleCategory("Umbi")}
        >
          Umbi
        </div>
      </div>
