...
function NewProduct() {
  ...
  const inputGram = ["5 KG", "2 KG", "8 KG"];
              ...
              <div className="new__product--right">
                <div className="new__product--right--content mx-auto">
                  ...
                  <div className="form-group position-relative">
                    ...
                    <textarea
                      placeholder="Describe your product min. 400 characters"
                  ...
                  <div className="form-group position-relative mb-0">
                    ...
                    <div className="size__wrapper--info row">
                      {inputSize?.map((item, index) => {
                        return (
                          <div
                            className={`size__wrapper--info--content--add col ${
